...
### Cuadernos legacy
- [```instructionTuning_peft.ipynb```](https://github.com/gplsi/Cuadernos/blob/main/instructionTuning_peft.ipynb): En este cuaderno se mostrará como realizar un instruction tunning a un gran modelo de lenguaje (LLM), concretamente, al modelo [FLAN-T5](https://huggingface.co/docs/transformers/model_doc/flan-t5) creado por Google.